...
text_splitter = RecursiveCharacterTextSplitter(chunk_size=300, chunk_overlaps=60, length_function=len)
...
def get_vectorstore(session_path: str):
    return Chroma(persist_directory="./ChromaDB/{session_path}", embedding_function=OpenAIEmbeddings())